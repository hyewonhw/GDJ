...
public class SelectOneMain {
	...
	public static void main(String[] args) {
		...
		ResultSet rs = null;  // 한 행씩 스캔하고 가져옴
		...
		try {
			...
			// 쿼리문 작성
			// SELECT문의 결과가 단일 행인 경우 SINGLE ROW
			// 1. WHERE절에서 PK 또는 UNIQUE 칼럼과 동등 비교(=) 수행
			// 2. 집계 함수의 결과를 조회
			String sql = "SELECT BOARD_NO, TITLE, CONTENT, HIT, CREATE_DATE FROM BOARD WHERE BOARD_NO = 4";
