...
-- //프로시저 작성//
-- 학과번호를(DEPTNO) 전달하면 소속 학생, 교수, 학과 모두 제거하는 프로시저 만들기
...
IS
BEGIN
    DELETE FROM STUDENT WHERE DEPTNO = DNO;  -- 학생
...
IS 
    SNO STUDENT.STUDNO%TYPE;   -- 학번 저장 할 변수
BEGIN
    SELECT STUDNO
      INTO SNO
      FROM STUDENT
