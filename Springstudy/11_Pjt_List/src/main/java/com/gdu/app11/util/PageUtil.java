...
public class PageUtil {
	...
	public String getPaging(String path) {
		...
		// 이전블록 : 1block이 아니면 이전블록이 있음 / 파라미터로 페이지번호 보내주기
		if(beginPage != 1) {
		...
		// 페이지번호 : 현재페이지는 클릭 안됨(링크가 없다) / beginPage부터 endPage까지 1씩 증가	
		...
		// 다음블록 : 마지막 블록 빼곤 다음블록 있음 / endPage와 totalPage가 다르면 마지막 블록
