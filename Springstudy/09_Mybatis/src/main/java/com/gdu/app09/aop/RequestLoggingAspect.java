...
public class RequestLoggingAspect {
	...
	@Pointcut("within(com.gdu.app09.controller..*)")  // controller 패키지 아래 모든 패키지(..)의 모든 클래스(*)
	...
	@Around("com.gdu.app09.aop.RequestLoggingAspect.setPointCut()")  // setPointCut() 메소드에 설정된 포인트컷에서 동작하는 어드바이스
