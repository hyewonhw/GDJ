...
@AllArgsConstructor  // Autowired대신 
@Service
public class UserServiceImpl implements UserService {
	...
	public Map<String, Object> isReduceId(String id) {
		...
		result.put("isUser", userMapper.selectUserById(id) != null);  // isUser에 true/false로 판별하기 위해 null이 아니면 true
	...
	public Map<String, Object> sendAuthCode(String email) {
		...
		// 이메일을 보내는 사용자 정보
		String username = "hwcho1205@gamil.com";  // 본인 지메일 주소
		String password = "xnybfqkgxusklqsy";     // 발급 받은 앱 비밀번호
