...
public class SpringMain {
	...
	public static void main(String[] args) {
		...
		AbstractApplicationContext ctx = new GenericXmlApplicationContext("classpath:xml01/appCtx.xml");	// classpath생략가능
		Calculator calculator = ctx.getBean("calc", Calculator.class); // "calc"가 id 
		calculator.add(5, 2);
		calculator.sub(5, 2);
		calculator.mul(5, 2);
		calculator.div(5, 2);
