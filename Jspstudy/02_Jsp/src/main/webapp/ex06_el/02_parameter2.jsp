...
<body>
	...
	<%--
		...
		2. 모든 파라미터는 String이므로 크기 비교를 수행할 수 없음
			예시)
			"10", "5" 중 누가 큰가? "5"가 크다(문자열의 크기는 사전 편찬 순) -> 10이 아니고 1이랑만 비교함
			"apple", "banana" -> b가 늦게나오기 때문에 크다고 인식
		3. 파라미터의 크기 비교
	...
	<!-- a - b의 값이 0보다 큰지,작은지 판단 -->
	<div>${param.a - param.b <  0}, ${param.a lt param.b}</div>
	<div>${param.a - param.b <= 0}, ${param.a le param.b}</div>
