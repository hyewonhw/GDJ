...
public class UploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/* C:\GDJ\Jspstudy\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\01_Servlet\ upload */

		/*
			1. FileUpload를 위한 COS 라이브러리
				1) http://servlets.com/
				2) [COS File Upload Library] - [Download] - [cos-22.05.zip]
				3) 압축 해제 후 lib 디렉터리에 cos.jar
		*/
		...
		*/
		...
		//     3) 실무에서는 한 곳에 모이지 않도록 첨부 파일의 경로를 매번 바꿔 줄 필요가 있음(IP주소,날짜 등)
		String realPath = getServletContext().getRealPath("upload");    // src/main/webapp(web root)
